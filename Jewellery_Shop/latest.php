...
<div class="container mt-2">
	<div class="row">
		<div class="col">
		<h3><center><b>Latest Items</b></center></h3>
	</div>
	</div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3" >
  <img src="images/l1.jpg" class="card-img-top" alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">Gold Earrings <br>Rs. 22000.00 </p>
          </div>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3">
  <img src="images/l2.png" class="card-img-top" alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">Flower Pearl Earrings <br>Rs. 5000.00</p>
          </div>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3">
  <img src="images/l3.jpg" class="card-img-top" alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">New Indian Jewellery <br>Rs. 10000.00</p>
          </div>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3">
  <img src="images/l4.jpg" class="card-img-top" alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">Latest Jewellery <br>Rs 10000.00</p>
          </div>
      </div>
...
<div class="container ">
  <div class="row">
    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3" >
  <img src="images/l5.jpg" class="card-img-top " alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">Bridal Jewellery <br>Rs. 20000.00 </p>
          </div>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3">
  <img src="images/l6.jpg" class="card-img-top" alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">Latest Necklace <br>Rs. 28000.00</p>
          </div>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3">
  <img src="images/l7.jpg" class="card-img-top" alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">Gold Chain <br>Rs. 200000.00</p>
          </div>
      </div>
  ...
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
      <div class="card mt-3">
  <img src="images/l8.jpg" class="card-img-top" alt="..." style="height: 14rem;">
          <div class="card-body">
    <p class="card-text text-center">Wedding Necklace <br>Rs. 500000.00</p>
          </div>
      </div>
...
<footer>
  	<div id="sub-footer">
  	<div class="container mt-3 mb-5" style="margin-bottom: 1px solid black;">
  		<div class="row">
