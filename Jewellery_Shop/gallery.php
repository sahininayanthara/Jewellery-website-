...
<div class="container mt-2">
	<div class="row">
		<div class="col">
		<h3><center><b>Gallery</b></center></h3>
	</div>
	</div>
</div>
...
<div class="container">
  ...
  <img src="images/g1.jpg" class="mx-auto d-block img-fluid mb-1" alt="..."style="height: 400px; width: 400px;" >
    </div>

  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
  <img src="images/g2.jpg" class="mx-auto d-block img-fluid mb-1" alt="..." style="height: 400px; width: 400px;">
      </div>
      
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
  <img src="images/g3.jpg" class="mx-auto d-block img-fluid mb-1" alt="..." style="height: 400px; width: 400px;"> 
    </div>
<div class="col-12 col-sm-6 col-md-6 col-lg-3">
  <img src="images/g4.jpg" class="mx-auto d-block img-fluid mb-1" alt="..." style="height: 400px; width: 400px;"> 
    </div>
  </div>
</div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
  <img src="images/g5.jpg" class="mx-auto d-block img-fluid mb-1" alt="..."style="height: 400px; width: 400px;" >
    </div>

  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
  <img src="images/g6.jpg" class="mx-auto d-block img-fluid mb-1" alt="..." style="height: 400px; width: 400px;">
      </div>
      
  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
  <img src="images/g7.jpg" class="mx-auto d-block img-fluid mb-1" alt="..." style="height: 400px; width: 400px;"> 
    </div>

<div class="col-12 col-sm-6 col-md-6 col-lg-3">
  <img src="images/g8.jpg" class="mx-auto d-block img-fluid mb-1" alt="..." style="height: 400px;width: 400px;"> 
    </div>
