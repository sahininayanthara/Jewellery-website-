...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
 ...
 <div class="container mt-2">
  <div class="row">
    <div class="col">
    <h3><center><b>Earrings</b></center></h3>
  </div>
  </div>
</div>
...
<div class="container">
	<div class="row">
		<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3" >
  <img src="images/e1.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Earrings <br>Rs. 5000.00 </p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/e2.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Rose Gold Earrings <br>Rs. 7000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/e3.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Round Gold Earrings <br>Rs. 4000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/e4.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Star Earrings <br>Rs 3000.00</p>
  				</div>
			</div>
...
<div class="container ">
	<div class="row">
		<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3" >
  <img src="images/e5.jpg" class="card-img-top " alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Golden Earrings <br>Rs. 12000.00 </p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/e6.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Earring with Perl <br>Rs. 20000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/e7.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Earrings <br>Rs. 12500.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/e8.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Bridal Earrings <br>Rs. 11000.00</p>
  				</div>
			</div>
