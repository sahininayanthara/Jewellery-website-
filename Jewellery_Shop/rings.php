...
<div class="container">
	<div class="row">
		<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3" >
  <img src="images/r1.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Silver Ring <br>Rs. 100.00 </p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/r2.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Rings <br>Rs. 5000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/r3.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Ring 3 Diamonds <br>Rs. 10000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/r4.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Rose Gold Rings <br>Rs 10000.00</p>
  				</div>
			</div>
...
<div class="container ">
	<div class="row">
		<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3" >
  <img src="images/r5.png" class="card-img-top " alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Wedding Ring <br>Rs. 20000.00 </p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/r6.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Diamond Ring <br>Rs. 28000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/r7.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Men's Ring <br>Rs. 8490.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/r8.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Diamond Ring <br>Rs. 50000.00</p>
  				</div>
			</div>
