...
<div class="container mt-2">
  <div class="row">
    <div class="col">
    <h3><center><b>Necklaces</b></center></h3>
  </div>
  </div>
</div>
...
<div class="container">
	<div class="row">
		<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3" >
  <img src="images/j1.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Necklace <br>Rs. 1000.00 </p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/j2.jpeg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Necklace <br>Rs. 2000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/j3.jpeg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Long Necklaces <br>Rs. 10000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/j4.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Real Diamond Necklace <br>Rs 1200000.00</p>
  				</div>
			</div>
...
<div class="container ">
	<div class="row">
		<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3" >
  <img src="images/j5.jpg" class="card-img-top " alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Diamond Necklace <br>Rs. 1759000.00 </p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/j6.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Silver Necklace <br>Rs. 1000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/j7.jpg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Necklace <br>Rs. 2350000.00</p>
  				</div>
			</div>
	...
	<div class="col-12 col-sm-6 col-md-6 col-lg-3">
			<div class="card mt-3">
  <img src="images/j8.jpeg" class="card-img-top" alt="..." style="height: 14rem;">
  				<div class="card-body">
    <p class="card-text text-center">Gold Necklace <br>Rs. 1500000.00</p>
  				</div>
			</div>
  	...
  	<div class="container mt-3 mb-3">
  		<div class="row">
  			<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
  				<div class="widget">
  						<li style="list-style: none; display: inline;"><a href="index.php" style="text-decoration: none;color: black">
  						Home</a>
  						</li>
  				</div>
  			</div>
  			...
  			<div class="col-12 col-sm-6 col-md-4">
  				<div class="widget">
  					<h5 class="widgetheading">Information</h5>
  						...
  						<li style="list-style: none;"><a href="services.php" style="text-decoration: none;color: black">Services</a></li>
